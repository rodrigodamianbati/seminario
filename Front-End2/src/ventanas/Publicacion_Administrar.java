...
public class Publicacion_Administrar extends JFrame {
	...
	public Publicacion_Administrar(String idioma, Participante participante) {
		// Creo la api
		api = new Api();
		...
		lblConcursosConInscripciones = new JLabel(bundle.getString("concurso.inscripcion_finalizado"));
		lblConcursosConInscripciones.setBounds(330, 11, 268, 14);
