...
public class Jueces_evaluaciones_Administrar extends JFrame {
	...
	private JLabel lblListadoGanadores = new JLabel();
	
	private TableColumn tc = new TableColumn();
	
	public Jueces_evaluaciones_Administrar(Api ap, String idioma, Concurso concurso) {
		...
		lblListadoGanadores = new JLabel("Listado de ganadores");
		lblListadoGanadores.setBounds(91, 108, 299, 15);
		contentPane.add(lblListadoGanadores);
		lblListadoGanadores.setVisible(false);
	...
	private void verificarConcursoCorregido(Concurso concurso) {
		...
		// Hora actual
			...
			if (hoy.isAfter(concurso.getFechaFinPublicacion()) || ( hoy.isEqual(concurso.getFechaFinPublicacion()) && hora > concurso.getHoraFinPublicacion()) ) {
				...
				btnEvaluarPublicaciones.setVisible(true);
			...
			lblListadoGanadores.setVisible(true);
			scrollPane3.setVisible(true);
			scrollPane.setVisible(true);
			this.table.setVisible(true);
			JOptionPane.showMessageDialog(null, "Recuerde Twittear a los ganadores!");
			btnAsignarPuestos.setVisible(false);
			lblPosiciones.setVisible(false);
			btnTwittear = new JButton(bundle.getString("twittear"));

			btnTwittear.setBounds(874, 305, 130, 50);
			...
			lblListaPremios = new JLabel("Listado de ganadores");
