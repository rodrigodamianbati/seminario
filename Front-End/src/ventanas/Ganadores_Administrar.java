...
public class Ganadores_Administrar extends JFrame {
	...
	public Ganadores_Administrar(Api ap, String idioma, Concurso concurso) {
...
//			// Hora actual
	...
	private void publicarTwitter(Concurso concurso) {
		...
		if (table.getValueAt(0, 2) == null) {
			...
			JOptionPane.showMessageDialog(null,"El twitt ha sido enviado!");
		}
	}
