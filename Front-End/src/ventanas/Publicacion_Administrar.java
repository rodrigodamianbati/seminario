...
public class Publicacion_Administrar extends JFrame {
	...
	private JLabel lblPublicacionesConcurso = new JLabel();
	...
	public Publicacion_Administrar(Api ap, String idioma, Participante participante) {
		...
		lblPublicacionesConcurso = new JLabel("New label");
		lblPublicacionesConcurso.setBounds(31, 235, 230, 15);
		contentPane.add(lblPublicacionesConcurso);
		
		lblPublicacionesConcurso.setVisible(false);
		...
		AbstractAction publicacionesConcurso = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
						...
						JTable table = (JTable) e.getSource();
						int modelRow = Integer.valueOf(e.getActionCommand());
						listarPublicacionesConcurso(/*concurso.getId()*/(int) table4.getValueAt(modelRow, 0), participante.getId());
		...
		ButtonColumn buttonColumn3 = new ButtonColumn(table4, publicacionesConcurso, 3);
		buttonColumn3.setMnemonic(KeyEvent.VK_D);
		
		AbstractAction agregarPublicacion = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
						...
						api.nuevaPublicacion((int) table4.getValueAt(modelRow, 0), participante, textArea.getText());
				...
				// Vacio los inputs
						...
						JOptionPane.showMessageDialog(null, bundle.getString("publicacion.exito.agregar"));
		...
		ButtonColumn buttonColumn4 = new ButtonColumn(table4, agregarPublicacion, 2);
	...
	private void listarPublicacionesConcurso(int id_concurso, int id_participante) {
		try {
			...
			lblPublicacionesConcurso.setText("Publicaciones del concurso " + api.concurso(id_concurso).getCodigo());
			lblPublicacionesConcurso.setVisible(true);
