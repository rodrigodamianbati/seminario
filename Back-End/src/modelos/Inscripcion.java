...
public class Inscripcion {
	...
	public int copareTo(Inscripcion inscripcion) {
		if (this.seInscribioDespues(inscripcion)) {
			return 1;
		}
		else {
			if (this.seInscribioAntes(inscripcion)) {
				return -1;
			}
			else
				return 0;
	...
	private boolean seInscribioAntes(Inscripcion inscripcion) {
		// TODO Auto-generated method stub
		return this.fechaInscripcion.isBefore(inscripcion.fechaInscripcion);
	}

	private boolean seInscribioDespues(Inscripcion fechaInscripcion2) {
		// TODO Auto-generated method stub
		return this.fechaInscripcion.isAfter(fechaInscripcion2.fechaInscripcion);
	}
